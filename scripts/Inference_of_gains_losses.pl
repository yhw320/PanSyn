...
if (!( defined $opts{node} and defined $opts{n1} and defined $opts{n2} and defined $opts{orth} and defined $opts{o})) {
	...
	-n1	The name of the interested ancestor node represented by a number (e.g. 1)
	-n2	The name of the ancestor node (adjacent to the evolution nodes of interest) represented by a number (e.g. 2)
	-orth	Full path to the [Orthogroup_Sequences] directory generated by [Orthofinder] software
