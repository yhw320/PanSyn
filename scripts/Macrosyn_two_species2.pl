...
if (defined $opts{h} or defined $opts{help}) {
	...
	-o5	Full path to the [outputDir_S21] directory
	...
	-pm	Full path to the pep file of species A (e.g. HSap.pep)
	...
	-name1	Interested species I by name abbreviations (default: same as -m)
	-name2	Interested species II by name abbreviations (default: same as -n)
