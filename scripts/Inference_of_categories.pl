...
if (!( defined $opts{g1} and defined $opts{g2} and defined $opts{a} and defined $opts{o})) {
		die "************************************************\n
	-g1	Full path to the [node*-Gain.OG.genes] file (generated by Inference_of_gains_losses)
	-g2	Full path to the [node*-Loss.OG.genes] file (generated by Inference_of_gains_losses)
