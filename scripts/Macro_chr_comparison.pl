...
if (!(defined $opts{i1} and defined $opts{m} and defined $opts{n} and defined $opts{gff} and defined $opts{color} and defined $opts{c} and defined $opts{g} and defined $opts{ab})) {
	...
	-ab	Full path to the [*_*] directory generated by the previously executed command [Macrosyn1], [Macrosyn_add_species] or [Macro_table_to_plot] (example: /PATH/HSap_MMus)
	Optional:
