...
use SVG;
GetOptions(\%opts,"pairs=s","m=s","n=s","o=s","gffm=s","gffn=s","pm=s","pn=s","g=s","s=s","color=s","c=s","e=s","p=s","name1=s","name2=s","l=s","h|help");
if (defined $opts{h} or defined $opts{help}) {
		die "************************************************\n
	-pairs	Full path to the *.pairs file 
	-m	Interested species I by name abbreviations (example: HSap)
	-n	Interested species II by name abbreviations (example: MMus)
	-o	Full path to the folder storing the output results (same as [-o2] in the previous script [Macrosyn_two_species1.pl])
	-gffm	Interested species I' GFF file (example: HSap.gff)
	-gffn	Interested species II' GFF file (example: MMus.gff)
	-pm	Interested species I' pep file (example: HSap.pep)
	-pn	Interested species II' pep file (example: MMus.pep)
	-g	Interested species II' genome file (example: MMus.fa)
	-s	Full path to the [syn_scripts] file PanSyn provided
	-color	Full path to the chr color
	Optional:
...
if (!(defined $opts{pairs} and defined $opts{m} and defined $opts{n} and defined $opts{o} and defined $opts{gffm} and defined $opts{gffn} and defined $opts{pm} and defined $opts{pn} and defined $opts{g} and defined $opts{s} and defined $opts{color})) {
		die "************************************************\n
	-pairs	Full path to the *.pairs file 
	-m	Interested species I by name abbreviations (example: HSap)
	-n	Interested species II by name abbreviations (example: MMus)
...
my $pathway_block="$opts{o}/$nv_cg/$opts{m}.block";
my $path_block="$opts{o}/$nv_cg/$opts{m}.block";
