...
open O1,">$opts{o}/node$opts{n1}-Lose.OG.fa";
open I,"<$opts{o}/node$opts{n1}-Lose.OG"; 
open O2,">$opts{o}/node$opts{n1}-Lose.OG.genes";
while (my $a=<I>) {
	chomp $a;
	open I1,"<$opts{orth}/$a.fa"; 
	while (my $a2=<I1>) {
...
close O1;
close O2;
system "cat $opts{o}/node$opts{n1}-Lose.OG.fa $opts{o}/node$opts{n1}-Gain.OG.fa >$opts{o}/for_emapper.pep";
