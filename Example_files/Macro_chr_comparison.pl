...
if (!(defined $opts{i1} and defined $opts{m} and defined $opts{n} and defined $opts{gff} and defined $opts{color} and defined $opts{c} and defined $opts{g} and defined $opts{ab})) {
	...
	-ab	Full path to the [*_*] directory generated by the previously executed script [Macrosyn1.pl], [Macrosyn_add_species.pl] or [Macro_table_to_plot.pl] (example: /PATH/HSap_MMus)
	Optional:
...
sub chromosome{
	...
	close O;
	system "rm $opts{ab}/chromosome_comparison/1";
	system("Rscript Chr_comparison.R $opts{ab}/chromosome_comparison/$spe1\_density.txt $opts{ab}/chromosome_comparison/$spe1\_karyotype.txt $opts{ab}/chromosome_comparison $spe1  $chr_num_max $opts{width} $opts{height} $opts{color}");
	system("Rscript Chr_comparison.R $opts{ab}/chromosome_comparison/$spe1\_$spe2\_density.txt $opts{ab}/chromosome_comparison/$spe1\_$spe2\_karyotype.txt $opts{ab}/chromosome_comparison $spe1\_$spe2 $chr_num_max $opts{width} $opts{height} $opts{color}");
	system("Rscript Chr_comparison.R $opts{ab}/chromosome_comparison/$spe1\_$spe2\_density_sig.txt $opts{ab}/chromosome_comparison/$spe1\_$spe2\_karyotype.txt $opts{ab}/chromosome_comparison $spe1\_$spe2\_sig $chr_num_max $opts{width} $opts{height} $opts{color}");
