...
use SVG;
GetOptions(\%opts,"i=s","m=s","n=s","e=s","c=s","color=s","gff=s","g=s","l=s","s=s","p=s","name1=s","name2=s","o=s","h|help");
if (defined $opts{h} or defined $opts{help}) {
	...
	-n	Interested species'name byabbreviations (example: HSap)
	-o	Full path to the folder storing the output results (same as [-o2] in the previous script [Pairs_to_table.pl])
	-gff	Interested species' GFF file (example: HSap.gff)
...
if (!(defined $opts{i} and defined $opts{m} and defined $opts{color} and defined $opts{n} and defined $opts{gff} and defined $opts{g} and defined $opts{s} and defined $opts{o})) {
		die "************************************************\n
	-i	Full path to the folder containing required data files (same as [-i] in the previous script [Macrosyn1_1_blast.pl])
	-m	Selected Ancestor'name by abbreviations (example: NVec)
	-n	Interested species'name byabbreviations (example: HSap)
...
my $pathway_pepm="$opts{i}/peps/$spename1.pep";
my $pathway_pepn="$opts{i}/peps/$spename2.pep";
...
sub getseqpair{
	...
	if ($c_chmun==1) {
		...
		open I,"<$opts{o}/$spename1\_$spename2.pairs2.score";
	...
	if ($c_chmun==2) {
		...
		open I,"<$opts{o}/$nv_cg.pairs2.score";
		open O,">$opts{o}/$nv_cg/Macrosyn_genes/pair3";
		while ($b=<I>){
			chomp $b;
			@items2=split/\t/,$b;
